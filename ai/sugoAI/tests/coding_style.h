static const char *CODING_STYLE = "Epitech Documentation"
""
"C Coding Style"
...
"follow."
"It covers:"
"• the organization of the delivery repository;"
...
"Minor rules are generally related to the visual presentation of the code, which can make the code difficult to read if not followed consistently. Repeatedly violating minor rules must be avoided, as it creates"
...
"3. Launch the appropriate script depending on your operating system (coding-style.sh for Unix-based"
"OS, coding-style.ps1 for Windows)."
...
"int main ( void )"
"{"
"printf (  [% s ] % s : % dn  , get_element_type () , get_element_name () ,"
"get _element_value () ) ;"
"my_putstr (  Writing multiline statements in C is easy , "
" you just need to break the line , and you are done !  ) ;"
"if ( c a l l _ t o _ a _ f u n c t i o n _ w i t h _ a _ l o n g _ b u t _ d e s c r i p t i v e _ n a m e ()"
...
""
"C-G6 - LINE ENDINGS"
"Line endings must be done in UNIX style (with n)."
...
"The line break character (n) is part of the line, and thus counts in its length."
""
...
"The length of a function is inversely proportional to its complexity, so a complicated"
...
"a = b = c = 0;"
"a ++; b ++;"
"if (( ptr = malloc ( sizeof ( struct my_struct ) ) ) != NULL )"
"if ( cond ) return ( ptr ) ;"
"for ( int i = 0; i < 42; i ++) {"
"..."
"}"
...
"// The comment block below is valid , even though it is indented with only one space"
"/* *"
"* @brief Something"
"*"
"* @param path"
...
"think about all the modifications you will have to make if you want to add a new statement to the block. This can also introduce some nasty bugs!"
"if ( cond ) { return ptr ;}"
"while ( cond ) {"
"do_something () ;"
"}"
...
"char * result = is_ co rr ect ly _f or mat te d ( str ) ? str : format ( str ) ;"
...
"ERROR_MESSAGE"
""
"3. 14 15 92 653 58 97 932 38 46"
"(( b ) * ( b ) - 4 * ( a ) * ( c ) )"
"{ num ++; printf (  % d  , num ) ;}"
" Multiline macros  "
" have to be avoided "
